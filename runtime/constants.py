...
WINDOW_VALLEY_THRESHOLD = 0.30
WINDOW_VALLEY_MIN_SECONDS = 0.20
WINDOW_VALLEY_SMOOTH_FRAMES = 5
...
RECOVERY_MAX_SPEECH_CONTEXT_SECONDS = 0.5
RECOVERY_CORE_MAX_SECONDS = 30.0
RECOVERY_MIN_UNCLAIMED_EDGE_SECONDS = 0.30
